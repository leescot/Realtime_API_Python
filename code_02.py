# modiflied code of https://github.com/kaneda2004/OpenAI_Realtime_Python_API
...
class RealtimeAPIClient:
    def __init__(self, api_key, websocket_url, audio_handler):
        ...
        self.voice = self.get_user_voice_choice()
    ...
    def get_user_voice_choice(self):
        """Prompt the user to choose a voice option using numbers."""
        voice_options = {
            "1": "alloy",
            "2": "echo",
            "3": "shimmer"
        ...
        while True:
            print("Please choose a voice option:")
            print("1. Alloy")
            print("2. Echo")
            print("3. Shimmer")
